...
import "./AjouterCandidat.css";

import Form from "react-bootstrap/Form";
import { TextField } from "@mui/material";
import icon1 from "../condidat.png";
import icon2 from "../condidate.png";
    ...
    <div className="all">
      <form className="ajout_form">
        {/* <div className="inpsec">
          <h2>
            <span>C</span>réation Compte pour Enseignant
          </h2>
        </div> */}
        <div className="inspec">
          <img className="user_icon" src={icon1} alt="icon" />
          <img className="user_icon" src={icon2} alt="icon" />
        </div>
        <div className="inpsec">
          <TextField
            id="standard-basic"
        ...
        <div className="inpsec">
          ...
          >
            <option>Spécialité étudiée</option>
